...
def new_workout_post():
    ...
    return redirect(url_for('main.user_workouts'))  # Corrected route name
...
def user_workouts():
    ...
    return render_template('all_workouts.html', workouts=workouts, user=user)  # Corrected template rendering
